...
//    }
    public void saveIDF(List<Tuple2<String,Long>> idfList) throws Exception {
        MongoCollection<Document> coll = mongoUtil.getCollection("candidate","idf5");
...
//                    System.out.println("IDFSet.count() = " + IDFSet.count());
                ...
                ArrayList<Tuple2<String, Long>> idfList = sortedOperator.collect().get(0);
